# RUI3-GNSS Tracker
RUI3 example code for WisBlock RAK12500 module.

This code is _**Work in progress**_ and far from finished. But it can give a first start how to use RUI3.     
and RAK3172 
The code compiles on and RAK3172. But on RAK3172 no other sensors are supported.    

Due to the small available Flash memory in the RAK3172 a reduced version of the Sparfun GPS library is included in the sources. Functions like navigation support, efs and geo fencing are removed to make the code significantly smaller.   
